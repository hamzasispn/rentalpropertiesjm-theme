    ...
    <div class="flex flex-col gap-4 lg:w-1/2 w-full">
        ...
        <ul class="flex flex-col gap-[0.833vw] mt-[1.25vw]">
            ...
            <li class="flex items-start gap-2 text-[3.765vw] md:text-[0.833vw]">
                ...
                <span class="flex-1"> No Spam - only genuine listing from real owners & property managers</span>
            </li>
            <li class="flex items-start gap-2 text-[3.765vw] md:text-[0.833vw]">
                <svg xmlns="http://www.w3.org/2000/svg" class="md:w-[1.25vw] md:h-[1.25vw] w-[5.647vw] h-[5.647vw]"
                    viewBox="0 0 24 24" fill="none">
            ...
            <li class="flex items-start gap-2 text-[3.765vw] md:text-[0.833vw]">
                ...
                <span class="flex-1"> Sponsored options - choose a package that give you an ad-free listing & pushes your property to the top of your category listing</span>
            </li>
            <li class="flex items-start gap-2 text-[3.765vw] md:text-[0.833vw]">
                <svg xmlns="http://www.w3.org/2000/svg" class="md:w-[1.25vw] md:h-[1.25vw] w-[5.647vw] h-[5.647vw]"
                    viewBox="0 0 24 24" fill="none">
