<div class="bg-white rounded-xl cursor-pointer flex flex-col shadow-sm hover:shadow-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:-translate-y-1 h-full"
    ...
    <div class="px-[3.294vw] pt-[2.824vw] pb-[5.647vw] md:px-[1.458vw] md:pt-[0.625vw] md:pb-[1.25vw] grow flex flex-col justify-between">
        ...
        <div class="flex gap-3 flex-wrap">
            ...
            <div x-show="property.bedrooms" class="flex items-center gap-2 px-[2.824vw] py-[1.412vw] md:px-[0.625vw] md:py-[7px] bg-gray-100 rounded-lg">
            ...
            <div x-show="property.bathrooms" class="flex items-center gap-2 px-[2.824vw] py-[1.412vw] md:px-[0.625vw] md:py-[7px] bg-gray-100 rounded-lg">
