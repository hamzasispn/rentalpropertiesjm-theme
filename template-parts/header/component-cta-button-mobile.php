<div class="lg:hidden flex flex-col gap-[2vw] sm:gap-[1.5vw] w-full">
    <a href="#" class="flex items-center gap-[2vw] sm:gap-[1.5vw] p-[2.5vw] sm:p-[2vw] bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
        <svg class="w-[5.5vw] h-[5.5vw] sm:w-[4.5vw] sm:h-[4.5vw] text-slate-700" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="text-[4vw] sm:text-[3vw] font-semibold text-slate-900">Search</span>
    </a>
    ...
    ?>
        <a href="<?= esc_url($profile_url); ?>" class="flex items-center gap-[2vw] sm:gap-[1.5vw] p-[2.5vw] sm:p-[2vw] bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
            <svg class="w-[5.5vw] h-[5.5vw] sm:w-[4.5vw] sm:h-[4.5vw] text-slate-700" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-[4vw] sm:text-[3vw] font-semibold text-slate-900">Profile</span>
        </a>

        <a href="<?= esc_url($list_url); ?>" class="btn-primary w-full px-[2vw] py-[2.5vw] sm:py-[2vw] text-[4vw] sm:text-[3vw] font-bold rounded-lg transition-all text-center">
            List Property Now
        </a>
    <?php else: ?>
        <a href="<?= esc_url($list_url); ?>" class="btn-primary w-full px-[2vw] py-[2.5vw] sm:py-[2vw] text-[4vw] sm:text-[3vw] font-bold rounded-lg transition-all text-center">
        ...
        <a href="<?= home_url('/login'); ?>" class="flex items-center gap-[2vw] sm:gap-[1.5vw] p-[2.5vw] sm:p-[2vw] bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-[5.5vw] h-[5.5vw] sm:w-[4.5vw] sm:h-[4.5vw] text-slate-700" viewBox="0 0 512 512">
                <g>
                    <path d="M218.668 240H16c-8.832 0-16-7.168-16-16s7.168-16 16-16h202.668c8.832 0 16 7.168 16 16s-7.168 16-16 16zm0 0" fill="currentColor"></path>
                    <path d="M138.668 320a15.89 15.89 0 0 1-11.309-4.691c-6.25-6.254-6.25-16.387 0-22.637l68.696-68.692-68.696-68.671c-6.25-6.254-6.25-16.387 0-22.637s16.383-6.25 22.637 0l80 80c6.25 6.25 6.25 16.383 0 22.637l-80 80A15.975 15.975 0 0 1 138.668 320zM341.332 512c-23.531 0-42.664-19.137-42.664-42.668v-384c0-18.238 11.605-34.516 28.883-40.512L455.723 2.09C484.395-6.7 512 14.57 512 42.668v384c0 18.219-11.605 34.473-28.863 40.488L354.922 509.91c-4.672 1.45-9 2.09-13.59 2.09zm128-480c-1.387 0-2.559.172-3.816.555L337.879 75.113c-4.184 1.453-7.211 5.676-7.211 10.219v384c0 7.277 7.89 12.184 14.484 10.113l127.637-42.558c4.16-1.453 7.211-5.676 7.211-10.219v-384C480 36.801 475.223 32 469.332 32zm0 0" fill="currentColor"></path>
            ...
            <span class="text-[4vw] sm:text-[3vw] font-semibold text-slate-900">Login</span>
        </a>
    <?php endif; ?>
</div>
