...
?>
    ...
    <div class="!mt-[0px] !mx-[0px] !mb-[0px] px-[6.833vw] md:px-[0.833vw] md:w-auto w-full <?= $is_best_seller ? 'bg-[var(--primary-color)]' : 'bg-white'; ?> pb-6 pt-[12.2vw] md:pt-[2.2vw] relative overflow-hidden shadow-lg rounded-[16px] flex flex-col gap-4 <?php echo $is_current ? 'border-2 border-blue-600' : ''; ?>">
        ...
        <div class="flex justify-between items-start mb-2">
            <h3 class="text-[6.875vw] md:text-[1.875vw] font-bold w-[70%] leading-[1] <?= $is_best_seller ? 'text-white' : 'text-[#1A1A1A]'; ?>">
                <?php echo esc_html($plan['name']); ?>
            </h3>
            <?php if ($is_current): ?>
                <span class="px-3 py-1 bg-blue-100 text-[var(--primary-color)] text-xs font-semibold rounded">Current Plan</span>
            <?php endif; ?>
        </div>
        ...
        <ul class="flex flex-col gap-5 <?= $is_best_seller ? 'text-white' : 'text-[#1A1A1A]'; ?>">
            ...
            <li class="font-bold font-inter text-[4.67vw] md:text-[0.99vw]">
                ...
                <span class="font-light">
                    <?= $plan['featured_limit'] == 1 ? 'Available' : 'Up to ' . esc_html($plan['featured_limit']) . ' properties'; ?>
                </span>
            </li>
